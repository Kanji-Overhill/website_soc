...
@section('content')
    ...
    <section class="mb-8">
        <div class="w-full text-center">
            <figure class="inline-block w-full"><img class="w-full" src="https://socasesores.com/img/quienes/convencion2.jpg" alt="" /></figure>
        </div>
    </section>

    <section class="md:pt-20 sm:pt-28 pt-20 hidden">
    ...
    <section class="md:py-20 py-10">
        <div class="container mx-auto max-w-6xl px-4 main-content lg:text-xl md:text-lg">
            ...
            <p>Somos una empresa mexicana fundada en el 2000, como <strong>la primera y más grande red de asesores financieros en México.</strong></p>
            <p>Te ayudamos a elegir el mejor crédito hipotecario, empresarial y/o seguro, según tu perfil y necesidades.</p>
            ...
            <p><strong>Nuestro servicio no tiene costo, sí, NO TIENE COSTO porque la institución financiera que elijas será la que cubrirá nuestros honorarios.</strong></p>
        </div>
    </section>

    <section class="md:py-20 py-10">
        <div class="container mx-auto max-w-6xl px-4 lg:text-lg md:text-lg">
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                <div class="px-4 w-full max-w-3xl mx-auto flex flex-col justify-between">
                    <div class="py-4 px-8 border border-primary rounded-3xl bg-white text-left mb-4">
                        ...
                        <div class="leading-relaxed">
                            <h2 class="text-primary text-lg title-font font-bold mb-3"><i class="inline-block rounded-tl-full bg-third w-6 h-6 mr-2 -mb-2"></i> Misión</h2>
                    ...
                    <div class="py-4 px-8 border border-primary rounded-3xl bg-white text-left mb-4">
                        ...
                        <div class="leading-relaxed">
                            <h2 class="text-primary text-lg title-font font-bold mb-3"><i class="inline-block rounded-bl-full bg-ligth-secundary w-6 h-6 mr-2 -mb-2"></i> Visión</h2>
                            <p>Ayudar a obtener el mejor producto financiero a las familias y empresas en Latinoamerica.</p>
                        </div>
                    </div>
                    <div class="py-4 px-8 border border-primary rounded-3xl bg-white text-left">
                        {{-- <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-ligth-primary text-indigo-500 mb-5 flex-shrink-0">
                            <svg fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-10 h-10" viewBox="0 0 24 24">
                        ...
                        <div class="leading-relaxed">
                            <h2 class="text-primary text-lg title-font font-bold mb-3"><i class="inline-block rounded-tl-full bg-fourth w-6 h-6 mr-2 -mb-2"></i> Valores</h2>
                            <p>Franqueza: Nos ayuda a comunicarnos</p>
                            <p>Humildad: Nos ayuda a escuchar</p>
                            <p>Compromiso: Son las ganas de salir adelante</p>
                            <p>Alegría: Es la mejor forma de agradecer</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="md:py-20 py-10 bg-primary text-white">
        <div class="container mx-auto max-w-6xl px-4 main-content lg:text-xl md:text-lg" id="counter">
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 font-light">
                <a href="{{ url('credito-hipotecario') }}" class="border-0 border-ligth-primary rounded-md p-6">
                    <h4 class="lg:text-7xl md:text-5xl text-3xl text-center font-bold mb-6">+<span class="count" data-count="23">0</span></h4>
                    <p>Más de 23 años de experiencia y más de 150,000 créditos otorgados.</p>
                </a>
                <a href="{{ url('credito-empresarial') }}" class="border-0 border-ligth-primary rounded-md p-6">
                ...
                <a href="{{ url('seguros') }}" class="border-0 border-ligth-primary rounded-md p-6">
    ...
    <section class="md:py-20 py-10 hidden">
        <div class="container mx-auto max-w-6xl px-4 main-content lg:text-xl md:text-lg">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 font-light">
                <div class="border border-gray-300 rounded-2xl p-6">
                    <ul class="list-sinergia">
                        <li>
                            <strong class="font-bold text-primary -mt-1">Marketing:</strong>
                        </li>
                    </ul>
                    <p>Nos enfocamos en el posicionamiento de la marca en diferentes eventos y medios masivos de comunicación</p>
                </div>
                <div class="border border-gray-300 rounded-2xl p-6">
                    <ul class="list-sinergia">
                        <li>
                            <strong class="font-bold text-primary -mt-1">Capacitación + tecnología:</strong>
                        </li>
                    </ul>
                    <p>Nos fortalecemos con webinars, e-learning y desarrollos propios para mantenernos actualizados y ofrecer un servicio especializado.</p>
                </div>
                <div class="border border-gray-300 rounded-2xl p-6">
                    <ul class="list-sinergia">
                        <li>
                            <strong class="font-bold text-primary -mt-1">Experiencia:</strong>
                        </li>
                    </ul>
                    <p>Tenemos más de 22 años de experiencia formando líderes en asesoría financiera.</p>
                </div>
            </div>
        </div>
    </section>
